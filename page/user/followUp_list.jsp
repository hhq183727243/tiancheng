    ...
    <section id="App">
        ...
        <div class="weui-panel weui-panel_access follow-up-list">
            <div class="weui-panel__bd">
                <div class="weui-media-box weui-media-box_appmsg" v-for="(item,index) in list" @click="bindChooseItme(item)">
                    ...
                    <div class="weui-media-box__bd">
                        ...
                        <p class="mt5 fix">
                            ...
                            <span class="weui-btn weui-btn_mini weui-btn_plain-primary r" @click.prevent="deleteItem(item,index)">取消关注</span>
                        </p>
                    </div>
                </div>
            </div>

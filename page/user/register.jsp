...
<body>
    ...
    <section>
        <form class="login-form">
            ...
            <p class="fix mt20">
               <a class="gm">❂</a> 注册即视为您同意《<a class="gm">注册协议</a>》
               <a class="g6" href="page/user/login.jsp">返回登录</a>
            </p>

            <button id="loginBtn" class="weui-btn bgm mt30" type="button">注册</button>
        </form>
    </section>
</body>
